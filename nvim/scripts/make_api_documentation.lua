--- The file that auto-creates documentation for `ztl`.
...
local function main()
    ...
    vimdoc.make_documentation_files({
        {
            source = vim.fs.joinpath(root, "lua", "ztl", "fncs.lua"),
            destination = vim.fs.joinpath(root, "doc", "ztl_api.txt"),
        },
        {
            source = vim.fs.joinpath(root, "lua", "types.lua"),
            destination = vim.fs.joinpath(root, "doc", "ztl_types.txt"),
        },
